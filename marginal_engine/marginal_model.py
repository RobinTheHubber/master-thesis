...
class FilterEquation:
    def __init__(self, update_function, initial_values_function, transformation_function,
                 get_initial_parameters_function, npar, constraints=None):
...
class MarginalObject:
    ...
    def __init__(self, distribution_module_epsilon, volatility_equation, mean_equation, parameters=None,
